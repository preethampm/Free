        ...
        <div className="w-full max-w-sm">
          ...
          {method === 'google' && (
            <button
              ...
              className="mt-6 w-full flex items-center justify-center gap-3 border border-gray-200 rounded-lg px-4 py-3.5 text-sm font-medium hover:bg-gray-50 hover:border-gray-300 transition-all min-h-[48px]"
            >
